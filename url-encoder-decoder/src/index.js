...
const FULL_TOOL = 'https://formatho.com/tools/url-encoder';
...
<title>URL Encoder &amp; Decoder Online — Free &amp; Private</title>
<meta name="description" content="Percent-encode or decode URLs instantly — free, privacy-first API. Zero tracking, zero data collection. Full browser tool on formatho.com.">
<link rel="canonical" href="https://url-encoder-formatho.filesformatho.workers.dev/">
<link rel="alternate" type="application/json" href="https://url-encoder-formatho.filesformatho.workers.dev/api">
<style>
...
<body>
<header>
  <h1>URL Encoder/Decoder Online — Free &amp; Private</h1>
...
<h2>Usage</h2>
<pre><code>curl &quot;https://url-encoder-formatho.filesformatho.workers.dev/api?text=hello%20world&amp;action=decode&quot;</code></pre>
<pre><code>curl "https://url-encoder-formatho.filesformatho.workers.dev/api?text=a%20b%2Fc%3Fd&action=encode"</code></pre>
<p>Full parameter reference and live response: <a href="https://url-encoder-formatho.filesformatho.workers.dev/api">/api endpoint</a>.</p>
...
<p>Prefer a UI? Use the complete client-side version — your data never even leaves your browser: <a href="https://formatho.com/tools/url-encoder">URL Encoder/Decoder Online on formatho.com</a>.</p>
...
<footer>© formatho.com · <a href="https://url-encoder-formatho.filesformatho.workers.dev/sitemap.xml">sitemap.xml</a> · Part of the <a href="https://formatho.com">Formatho</a> privacy-first tool suite.</footer>
</body>
</html>
`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://url-encoder-formatho.filesformatho.workers.dev/</loc>
    <changefreq>monthly</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://url-encoder-formatho.filesformatho.workers.dev/api</loc>
    <changefreq>monthly</changefreq>
