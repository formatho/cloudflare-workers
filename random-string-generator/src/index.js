...
const FULL_TOOL = 'https://formatho.com/tools/token-generator';
...
<title>Random String Generator Online — Free &amp; Private</title>
<meta name="description" content="Generate cryptographically secure random strings — numeric, alphanumeric or special charsets. Free, zero tracking. Full tool on formatho.com.">
<link rel="canonical" href="https://random-string-formatho.filesformatho.workers.dev/">
<link rel="alternate" type="application/json" href="https://random-string-formatho.filesformatho.workers.dev/api">
<style>
...
<body>
<header>
  <h1>Random String Generator Online — Free &amp; Private</h1>
...
<h2>Usage</h2>
<pre><code>curl &quot;https://random-string-formatho.filesformatho.workers.dev/api?length=32&amp;charset=alphanumeric&quot;</code></pre>
<pre><code>curl "https://random-string-formatho.filesformatho.workers.dev/api?length=6&charset=numeric"</code></pre>
<p>Full parameter reference and live response: <a href="https://random-string-formatho.filesformatho.workers.dev/api">/api endpoint</a>.</p>
...
<p>Prefer a UI? Use the complete client-side version — your data never even leaves your browser: <a href="https://formatho.com/tools/token-generator">Random String Generator Online on formatho.com</a>.</p>
...
<footer>© formatho.com · <a href="https://random-string-formatho.filesformatho.workers.dev/sitemap.xml">sitemap.xml</a> · Part of the <a href="https://formatho.com">Formatho</a> privacy-first tool suite.</footer>
</body>
</html>
`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://random-string-formatho.filesformatho.workers.dev/</loc>
    <changefreq>monthly</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://random-string-formatho.filesformatho.workers.dev/api</loc>
    <changefreq>monthly</changefreq>
